...
const Skills = () => {
  ...
  return (
    <section id='Skills' className='flex flex-col items-center pb-10'>
        ...
        <div className=' bg-indigo-900 w-auto h-44 sm:h-full sm:w-8/12 overflow-x-auto overscroll-x-contain flex p-5 items-center justify-center rounded-xl sm:overflow-hidden sm:flex-wrap mx-4'>
