  ...
  return (
    <section className="flex flex-col w-8/12 m-auto">
      ...
      <div className=" bg-indigo-900 rounded-xl w-full">
        <div className=" flex items-center justify-center hover:bg-indigo-500 hover:rounded-xl p-5 h-1/2">
          <p className=" text-white mr-5 text-2xl">Desarrollo web</p>
          <Modal urlCertificate={'https://i.imgur.com/XAA2VAD.png'} altCertificate={'certificado desarrollo web'} />
        </div>
        <div className=" flex items-center justify-center hover:bg-indigo-500 hover:rounded-xl p-5 h-1/2">
          <p className=" text-white mr-5 text-2xl">JavaScript</p>
